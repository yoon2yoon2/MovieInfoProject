...
<form name=updateForm method=post action="${pageContext.request.contextPath}/board/update" onSubmit="return checkValid()">
    ...
    <tr>
        <td width="1220" height="20" colspan="2" bgcolor="#00cc00">
            <p align="center"><font color="white" size="3"><b> ${elec.modelNum} 게시물 수정하기</b></font></p>
        </td>
    </tr>
    <tr>
		...
		<input type=text name="modelName" size="30"
		 value="${requestScope.elec.modelName}"></span></b></td>
    </tr>
    <tr>
        <td width="150" height="20">
		...
		<input type=text name="price" size="30"
		 value="${requestScope.elec.price}"></span></b></td>
    </tr>
    ...
    <tr>
        ...
        <td width="450" height="20" ><b><span style="font-size:9pt;">
		<textarea name="description" cols="50" rows="10">${requestScope.elec.description}</textarea></span></b></td>
    </tr>
    <tr>
        <td width="150" height="20" >
